...
def initialize_model(model_name, num_classes, feature_extract, encoder_checkpoint, use_pretrained=False):
    ...
    if model_name == "resnet50":
        ...
        model_ft = ResNet_subVideo_KeyFramePlusAllNormed(num_classes=num_classes, pretrained=use_pretrained, resnet50=True,
                                           feature_extract=feature_extract, alpha=1, Encoder_CheckPoint=encoder_checkpoint)
        input_size = (224, 224)
    elif model_name == "ResNet_subVideo_KeyFramePlusDimentioned":
        model_ft = ResNet_subVideo_KeyFramePlusDimentioned(num_classes=num_classes, pretrained=use_pretrained, resnet50=True,
                                           feature_extract=feature_extract, Encoder_CheckPoint=encoder_checkpoint)
        input_size = (224, 224)
    elif model_name.find("ResNet_subVideo_KeyFramePlusDimentionedV2")==0:
        ...
        model_ft = ResNet_subVideo_KeyFramePlusDimentionedV3(num_classes=num_classes, pretrained=use_pretrained, resnet50=True,
                                           feature_extract=feature_extract, Encoder_CheckPoint=encoder_checkpoint, normalization_type=model_name)
        input_size = (224, 224)
    elif model_name.find("ResNet_subVideo_KeyFrameDimentionedAfterPlus")==0:
        model_ft = ResNet_subVideo_KeyFrameDimentionedAfterPlus(num_classes=num_classes, pretrained=use_pretrained, resnet50=True,
                                           feature_extract=feature_extract, Encoder_CheckPoint=encoder_checkpoint)
        input_size = (224, 224)
    else:
